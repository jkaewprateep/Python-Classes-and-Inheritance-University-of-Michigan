...
🦭💬 Do you mean that with a small amount of secondary items in the environment are affected differently then we have a random function that responds the input by multiplying with the trained weight to execute the function⁉️ </br>
